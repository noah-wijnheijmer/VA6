...
if pages == 'Home':
    ...
    st.subheader("Hier worden de visualisaties weergegeven die wij hebben opgesteld."), st.image("bar1.png", width=None ,output_format='auto'), st.image("bar2.png", width=None ,output_format='auto'),
    st.image("scatter.png", width=None ,output_format='auto'), st.plotly_chart(fig) 
elif pages == 'Einde':
